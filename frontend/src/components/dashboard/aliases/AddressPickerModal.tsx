      ...
      <OverlayContainer>
        ...
        >
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className={styles.promotionalsBlockingControl}>
              <input
                type="checkbox"
              ...
              >
                ...
                <p className={styles.promotionalsBlockingDescription}>
                  {l10n.getString(
                    "popover-custom-alias-explainer-promotional-block-tooltip"
                  )}
